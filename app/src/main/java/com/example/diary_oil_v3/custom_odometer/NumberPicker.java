...
/**
 * Created by chiragpatel on 17-05-2017.
 */
...
public class NumberPicker extends LinearLayout {
     ...
     */
    private static final int DEFAULT_TEXT_COLOR = 0xffffffff; //white
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        mTextColor = attributesArray.getColor(R.styleable.NumberPicker_np_text_color, mTextColor);
        mTextSize = attributesArray.getDimension(R.styleable.NumberPicker_np_text_size, spToPx(mTextSize));
        ...
        inflater.inflate(R.layout.number_picker_selector_wheel, this, true);
...
//            if (i != mWheelMiddleItemIndex || mSelectedText.getVisibility() != VISIBLE) { //remove
...
//            }
    ...
    private void onScrollerFinished(Scroller scroller) {
        if (scroller == mFlingScroller) {
            ...
            onScrollStateChange(NumberPicker.OnScrollListener.SCROLL_STATE_IDLE);
        } else if (mScrollState != NumberPicker.OnScrollListener.SCROLL_STATE_TOUCH_SCROLL) {
            updateInputTextView();
        }
    }
    ...
    /**
     * Posts an {@link NumberPicker.SetSelectionCommand} from the given <code>selectionStart
    ...
    private NumberPicker.Formatter stringToFormatter(final String formatter) {
        if (TextUtils.isEmpty(formatter)) {
            return null;
        }

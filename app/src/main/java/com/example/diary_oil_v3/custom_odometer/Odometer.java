package com.example.diary_oil_v3.custom_odometer;
...
public class Odometer extends LinearLayout {
    ...
    private void createDynamicNumberPicker(Context context) {
        ...
        for (int i = 1; i <= slot; i++) {
            com.example.diary_oil_v3.custom_odometer.NumberPicker numberPicker = new com.example.diary_oil_v3.custom_odometer.NumberPicker(context);
            LayoutParams lp = new LayoutParams(90, LayoutParams.WRAP_CONTENT);
            lp.setMargins(2, 0, 2, 0);
            lp.gravity = Gravity.CENTER;
            numberPicker.setLayoutParams(lp);

            setDividerColor(numberPicker, 0xff7f7f7f); //grey color
...
//    public void setNumberPickerTextColor(com.example.diary_oil_v3.custom_odometer.NumberPicker numberPicker, int color, String fontName, float textSize) {
...
//    }
    ...
    public void setDividerColor(com.example.diary_oil_v3.custom_odometer.NumberPicker picker, int color) {
        Field[] pickerFields = com.example.diary_oil_v3.custom_odometer.NumberPicker.class.getDeclaredFields();
    ...
    public String getFinalOdometerValue() {
        ...
        try {
            for (int i = 0; i < llParent.getChildCount(); i++) {
                ...
                com.example.diary_oil_v3.custom_odometer.NumberPicker localNumberPicker = (com.example.diary_oil_v3.custom_odometer.NumberPicker) llParent.getChildAt(i);
            ...
            Log.d("Custom picker",Log.getStackTraceString(e));
        }
